...
<?php
     header('Location: index.php');
    $_SESSION["err"] = "Login using new Id/Password.";
...
<form action="changepassword.php" method="POST">
  ...
  <div class="container">
  <label for="projects"><b>Change ID/Password</b> </label>
  <div class="row">
    <div class="col-sm-3" >
      <p>ID<p>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-3" >
      <input type="hidden" class="form-control" value="<?php echo  $rec["id"]; ?>" name="id" id="exampleInputPassword1" placeholder="Os Name">
    <input type="text" class="form-control" value="<?php echo  $rec["user_id"]; ?>" name="user_id" id="exampleInputPassword1" placeholder="Os Name">
    </div>
    <div class="col-sm-7" >
     <input type="password" class="form-control" value="<?php echo  $rec["password"]; ?>" name="password" id="exampleInputPassword1" placeholder="OS Editions">  
    </div>
        <div class="col-sm-2" >
