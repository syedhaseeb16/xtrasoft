...
//update data 
  ...
  $Category=$_POST['Category'];
   // $queryyy_up = "INSERT INTO products(Product,Manufacturer_id,guideuser_EN_LINK,guideuser_FR_LINK,guide_faq_EN_LINK,guide_faq_FR_LINK) VALUES('$Product','$Manufacturer_id','$guideuser_EN_LINK','$guideuser_FR_LINK','$guide_faq_EN_LINK','$guide_faq_FR_LINK')";
      ...
      $queryyy_up = "UPDATE `products` SET `Product`='$Product',`Manufacturer_id`='$Manufacturer_id',`guideuser_EN_LINK`='$guideuser_EN_LINK',`guide_faq_EN_LINK`='$guide_faq_EN_LINK',`guideuser_FR_LINK`='$guideuser_FR_LINK',`guide_faq_FR_LINK`='$guide_faq_FR_LINK' WHERE `Product_ID`='$product_id_update'";
  ...
  if (mysqli_query($conn, $queryyy_up)) {
     ...
     //getting os compatiblity data from form os editions
      ...
      $Windows_OS_download_fr=$Download_FR_LINK;
         ...
         $Windows="Windows";
         $queryyy = "UPDATE `product_record` SET `os_id`=4,`OS`='$Windows',`OS_Edition`='$Windows_OS_Edition',`Product`='$Product',`Category`='$Category',`Manufacturer`='$Manufacturer_id',`Download_EN_LINK`='$Windows_OS_download_en',`Download_FR_LINK`='$Windows_OS_download_fr' WHERE `Product_ID`='$product_id_update'";
...
$queryyy="UPDATE `videos_section` SET `overviewen_window`='$overviewen_window',`overviewfr_window`='$overviewfr_window',`installen_window`='$installen_window',`installfr_window`='$installfr_window',`activateen_window`='$activateen_window',`activatefr_window`='$activatefr_window',`autorenewen_window`='$autorenewen_window',`autorenewenfr_window`='$autorenewenfr_window',`overviewen_iOS`='$overviewen_iOS',`overviewfr_iOS`='$overviewfr_iOS',`installen_iOS`='$installen_iOS',`installfr_iOS`='$installfr_iOS',`activateen_iOS`='$activateen_iOS',`activatefr_iOS`='$activatefr_iOS',`autorenewen_iOS`='$autorenewen_iOS',`autorenewenfr_iOS`='$autorenewenfr_iOS',`overviewen_linux`='$overviewen_linux',`overviewfr_linux`='$overviewfr_linux',`installen_linux`='$installen_linux',`installfr_linux`='$installfr_linux',`activateen_linux`='$activateen_linux',`activatefr_linux`='$activatefr_linux',`autorenewen_linux`='$autorenewen_linux',`autorenewenfr_linux`='$autorenewenfr_linux',`overviewen_mac`='$overviewen_mac',`overviewfr_mac`='$overviewfr_mac',`installen_mac`='$installen_mac',`installfr_mac`='$installfr_mac',`activateen_mac`='$activateen_mac',`activatefr_mac`='$activatefr_mac',`autorenewen_mac`='$autorenewen_mac',`autorenewenfr_mac`='$autorenewenfr_mac',`overviewen_andriod`='$overviewen_andriod',`overviewfr_andriod`='$overviewfr_andriod',`installen_andriod`='$installen_andriod',`installfr_andriod`='$installfr_andriod',`activateen_andriod`='$activateen_andriod',`activatefr_andriod`='$activatefr_andriod',`autorenewen_andriod`='$autorenewen_andriod',`autorenewenfr_andriod`='$autorenewenfr_andriod' WHERE `product_id`='$product_id_update'";
  ...
  if (mysqli_query($conn, $queryyy_up)) {
     ...
     //getting os compatiblity data from form os editions
      ...
      //andriod
       ...
       $queryyy = "UPDATE `product_record` SET `os_id`='1',`OS`='Android',`OS_Edition`='$Andriod_OS_Edition',`Product`='$Product',`Category`='$Category',`Manufacturer`='$Manufacturer_id',`Download_EN_LINK`='$Andriod_download_en',`Download_FR_LINK`='$Andriod_download_fr' WHERE `Product_ID`='$product_id_update' AND os_id='1'";
       echo $queryyy."<br>";
      ...
      //iOS
      $queryyy = "UPDATE `product_record` SET `os_id`='2',`OS`='iOS',`OS_Edition`='$iOS_OS_Edition',`Product`='$Product',`Category`='$Category',`Manufacturer`='$Manufacturer_id',`Download_EN_LINK`='$iOS_OS_download_en',`Download_FR_LINK`='$iOS_OS_download_fr' WHERE `Product_ID`='$product_id_update' AND os_id='2'";
echo $queryyy."<br>";
      ...
      $queryyy = "UPDATE `product_record` SET `os_id`='3',`OS`='Mac',`OS_Edition`='$Mac_OS_Edition',`Product`='$Product',`Category`='$Category',`Manufacturer`='$Manufacturer_id',`Download_EN_LINK`='$Mac_OS_download_en',`Download_FR_LINK`='$Mac_OS_download_fr' WHERE `Product_ID`='$product_id_update' AND os_id='3'";
echo $queryyy."<br>";
        if (mysqli_query($conn, $queryyy)) {
          //echo "okmac2<br>";
        }else {
      echo "Error creating record : " . mysqli_error($conn);
        ...
        //Windows
         $queryyy = "UPDATE `product_record` SET `os_id`='4',`OS`='Windows',`OS_Edition`='$Windows_OS_Edition',`Product`='$Product',`Category`='$Category',`Manufacturer`='$Manufacturer_id',`Download_EN_LINK`='$Windows_OS_download_en',`Download_FR_LINK`='$Windows_OS_download_fr' WHERE `Product_ID`='$product_id_update'AND os_id='4'";
...
echo $queryyy."<br>";
      ...
      echo "Error creating record : " . mysqli_error($conn);
       ...
       //Linux  
      $queryyy = "UPDATE `product_record` SET `os_id`='5',`OS`='Linux',`OS_Edition`='$Linux_OS_Edition',`Product`='$Product',`Category`='$Category',`Manufacturer`='$Manufacturer_id',`Download_EN_LINK`='$Linux_OS_download_en',`Download_FR_LINK`='$Linux_OS_download_fr' WHERE `Product_ID`='$product_id_update' AND os_id='5'";
echo $queryyy."<br>";
